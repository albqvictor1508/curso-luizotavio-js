...
/* harmony export */ });
/* harmony import */ var _modules_validarCPF2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/validarCPF2 */ "./public/modules/validarCPF2.js");
...
var CPF = /*#__PURE__*/function () {
  ...
  return _createClass(CPF, [{
    ...
    get: function get() {
      ...
      this.gerarCPF();
      var validacao = this.novoCpf === this.cpfLimpo;
      if (validacao) {
    ...
    key: "gerarDigitos",
    value: function gerarDigitos(cpf) {
      var total = 0;
      var mult = cpf.length + 1;
...
/* harmony import */ var _public_modules_geraCPF__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../public/modules/geraCPF */ "./public/modules/geraCPF.js");
